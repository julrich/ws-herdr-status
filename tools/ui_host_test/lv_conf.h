...
/* The harness aborts with the raise site instead of halting (host_assert.h
 * undefines and replaces LV_ASSERT_HANDLER). */
#define LV_ASSERT_HANDLER_INCLUDE "host_assert.h"
